        ...
        const continents = [
          {
            ...
            MapComponent: <EuropeMap viewBox="330 100 500 575" class="continent-map" />,
            id: 'europe',
          },
          {
            name: 'North America',
            ...
            MapComponent: <NorthAmericaMap class="continent-map" />,
            id: 'north-america',
          },
          {
            name: 'South America',
            ...
            MapComponent: <SouthAmericaMap class="continent-map" />,
            id: 'south-america',
          },
          {
            name: 'Africa',
            ...
            MapComponent: <AfricaMap class="continent-map" />,
            id: 'africa',
          },
          {
            name: 'Asia',
            ...
            MapComponent: <AsiaMap class="continent-map" />,
            id: 'asia',
          },
          {
            name: 'Oceania',
            ...
            MapComponent: <OceaniaMap viewBox="-50 0 297 210" class="continent-map" />,
            id: 'oceania',
          },
        ];
